InputRangeJsv.prototype.names = {
	elem: 'input-range-jsv',
	devider: '__',
	track: 'track',
	trackIn: 'track-inner',
...
InputRangeJsv.prototype.recalculateTrack = function(e) {
...
InputRangeJsv.prototype.mouseAction = function(e, that) {
...
InputRangeJsv.prototype.inputAction = function(e, that, i) {
	that.valueInput = true;
	that.activePart = i;
	that.setPosition(e, that);
}

InputRangeJsv.prototype.addEvents = function(that) {
...
InputRangeJsv.prototype.setPosition = function(e, that) {
...
InputRangeJsv.prototype.setMousePosition = function(e, that) {
	let ap = that.parts[that.activePart];
...
InputRangeJsv.prototype.setActivePart = function(e, that) {
	if (that.parts.length > 1) {
...
InputRangeJsv.prototype.moveThumb = function(that) {
	let ap = that.parts[that.activePart];
...
InputRangeJsv.prototype.setResult = function(that) {
	let ap = that.parts[that.activePart],
